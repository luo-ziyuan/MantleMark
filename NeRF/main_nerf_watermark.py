...
from loss import huber_loss, NeRFLoss_freq
...
if __name__ == '__main__':
    ...
    ### training options
    parser.add_argument('--iters', type=int, default=30000, help="training iters") #30000
    ...
    parser.add_argument('--downscale', type=float, default=1, help="downscale")
...
#         data = json.load(file)
#         opt.mean_dis = data["mean_dis"]
#         opt.min_f = data["min_f"]
#         opt.max_f = data["max_f"]
    print(opt)
